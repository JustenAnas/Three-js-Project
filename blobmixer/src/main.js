...
const blobs = [
  {
    name: 'Fomosphere',
    background: '#75BCC6',
    config: { "uPositionFrequency":  1.15, "uPositionStrength": 0.44, "uTimeFrequency":0.25,"uSmallWavePositionFrequency":  2.0, "uSmallWavePositionStrength": 0.17, "uSmallWaveTimeFrequency": 0.14, "roughness":0.16, "metalness": 1 , "envMapIntensity": 2.1, "clearcoat": 0.82, "clearcoatRoughness": 0.38, "transmission": 0.65, "flatShading": false, "wireframe": false, "map": "cd" },
  },
  {
    name: 'Discobrain',
    background: '#7600F0',
    config: { "uPositionFrequency":  2.05, "uPositionStrength": 0.08, "uTimeFrequency":1.15,"uSmallWavePositionFrequency":  2.54, "uSmallWavePositionStrength": 0.19, "uSmallWaveTimeFrequency": 0.97, "roughness":0.16, "metalness": 1 , "envMapIntensity": 2.1, "clearcoat": 0.82, "clearcoatRoughness": 0.38, "transmission": 0.65, "flatShading": false, "wireframe": false, "map": "rainbow" },
  },
  {
    name: 'Color Fusion',
    background: '#FDCF8A',
    config: { "uPositionFrequency": 2.6, "uPositionStrength": 0.75, "uTimeFrequency": 0.82,"uSmallWavePositionFrequency": 0.68, "uSmallWavePositionStrength": 0.84, "uSmallWaveTimeFrequency": 0.68,"roughness": 0.09, "metalness": 1, "envMapIntensity": 2, "clearcoat": 0, "clearcoatRoughness": 0, "transmission": 0, "flatShading": false, "wireframe": false, "map": "cosmic-fusion" },
  },
  {
    name: 'Purple Mirror',
    background: '#5300B1',
...
const mergedGeometry = BufferGeometryUtils.mergeVertices(
  new THREE.IcosahedronGeometry(1, 70)
);
